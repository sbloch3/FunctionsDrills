...
#the function.
#Print what the function returns.
def Parem1_Parem2 (Parem1 + Parem2):
...
#call the function.
#Print what the function returns.
def Parem4_Parem5_Parem6 (Parem4 + Parem5 + Parem6):
    return(Parem4 + Parem5 + Parem6)
print(return)
...
def favcolor_blue_thatsmyfavoritecolor! (favcolor = blue):
    return = blue
print(return)
